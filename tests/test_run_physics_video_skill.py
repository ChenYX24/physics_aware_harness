...
class RunPhysicsVideoSkillTests(unittest.TestCase):
    ...
    def test_skill_is_controller_only_and_preserves_m3_boundary(self) -> None:
        ...
        for required in (
            ...
            "inspect.local_asset_registrations",
            "required `source_uri_hint` is exact",
            ...
            "recover-interrupted",
            "retry-failed",
            "failed_stage_retry.available=true",
            "case_spec_contract_repair.available=true",
            "box_mesh_v1",
            "[pitch, yaw, roll]",
            "recompile-after-config",
            "configuration_recompile.available=true",
            "retry-review-after-contract-fix",
            "reviewer_contract_retry.available=true",
