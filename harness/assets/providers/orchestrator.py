...
class AssetProviderOrchestrator:
    ...
    def _fulfill_one(
        ...
        *,
        ...
        generated = generate_box_obj(normalized, request_dir / "box_mesh_v1.obj")
        ...
        if not str(quality["status"]).startswith("pass"):
            receipt = self._receipt(
                receipt_id=receipt_id,
                request=request,
                normalized=normalized,
            ...
            return (
                provider_failure(
                    ...
                    message=f"registered generated asset failed qualification: {quality['failure_codes']}",
                    receipt_ids=[receipt_id],
                ),
                receipt,
            )
    ...
    def _catalog_asset(
        ...
        *,
        ...
        mass = size[0] * size[1] * size[2] * 1000.0
        ...
        return {
            "asset_id": asset_id,
            "name": f"Generated Box {asset_id.rsplit('.', 1)[-1]}",
            "semantic_name": str(intent.search_intent.raw_query),
            "description": "Deterministic centered box mesh generated by box_mesh_v1",
            "aliases": [asset_id, "generated box", "box mesh"],
            "tags": [intent.legacy_intent.role, "box", "procedural_generation"],
            ...
            "collision": {"present": True, "kind": "box"},
            "files": [
                *imported_files,
                {
